#
#  Be sure to run `pod spec lint ZHKFeedback.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/ZHK1024/ZHKFeedback.git", :tag => s.version }
  ...
  s.source_files  = "ZHKFeedback/**/*.{h,m}"
